...
Xil_Out32(XPAR_MYIP_AXI_LUD_WRAPPER_0_BASEADDR + 4*15, 0); //Making enable 0
delay_FPGALoad_INST();
Xil_Out32(XPAR_MYIP_AXI_LUD_WRAPPER_0_BASEADDR + 4*16, 0); //Making write enable 0
delay_FPGALoad_INST();
//Writing 0 into BRAM
for(i=0;i<1024;i++){
Xil_Out32(XPAR_MYIP_AXI_LUD_WRAPPER_0_BASEADDR + 4*14, i); //Writing address
delay_FPGALoad_INST();
for(j=0;j<sub_instructions;j++){
Xil_Out32(XPAR_MYIP_AXI_LUD_WRAPPER_0_BASEADDR + 4*(17+j), 0); //Writing data in din
delay_FPGALoad_INST();
}
Xil_Out32(XPAR_MYIP_AXI_LUD_WRAPPER_0_BASEADDR + 4*15, 1); //Making enable 1
delay_FPGALoad_INST();
Xil_Out32(XPAR_MYIP_AXI_LUD_WRAPPER_0_BASEADDR + 4*16, 1); //Making write enable 1
delay_FPGALoad_INST();
Xil_Out32(XPAR_MYIP_AXI_LUD_WRAPPER_0_BASEADDR + 4*15, 0); //Making enable 0
delay_FPGALoad_INST();
Xil_Out32(XPAR_MYIP_AXI_LUD_WRAPPER_0_BASEADDR + 4*16, 0); //Making write enable 0
...
for(i=0;i<1024;i++){
Xil_Out32(XPAR_MYIP_AXI_LUD_WRAPPER_0_BASEADDR + 4*14, i); //Writing address,i is the offset
delay_FPGALoad_INST();
Xil_Out32(XPAR_MYIP_AXI_LUD_WRAPPER_0_BASEADDR + 4*15, 1); //Making enable 1
delay_FPGALoad_INST();
for(j=0;j<sub_instructions;j++){
val = Xil_In32(XPAR_MYIP_AXI_LUD_WRAPPER_0_BASEADDR + 4*(19+j)); //Reading from BRAM
delay_FPGALoad_INST();
if(val != 0){
...
delay_FPGALoad_INST();
for(j=0;j<sub_instructions;j++){
Xil_Out32(XPAR_MYIP_AXI_LUD_WRAPPER_0_BASEADDR + 4*(17+j), Inst[i][j]); //Writing data in din
delay_FPGALoad_INST();
}
Xil_Out32(XPAR_MYIP_AXI_LUD_WRAPPER_0_BASEADDR + 4*15, 1); //Making enable 1
delay_FPGALoad_INST();
...
delay_FPGALoad_INST();
for(j=0;j<sub_instructions;j++){
val_int = Xil_In32(XPAR_MYIP_AXI_LUD_WRAPPER_0_BASEADDR + 4*(19+j)); //Reading from BRAM
delay_FPGALoad_INST();
if(val_int != Inst[i][j]){
