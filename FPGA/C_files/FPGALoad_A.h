...
for(i=0;i<4;i++){
for(j=0;j<1024;j++){
Xil_Out32(XPAR_MYIP_AXI_LUD_WRAPPER_0_BASEADDR + 4*(4+i), j); //Writing address,(4+i) is the offset
delay_FPGALoad_A();
Xil_Out32(XPAR_MYIP_AXI_LUD_WRAPPER_0_BASEADDR + 4*(8+i), 0); //Writing data in din
delay_FPGALoad_A();
Xil_Out32(XPAR_MYIP_AXI_LUD_WRAPPER_0_BASEADDR + 4*(16+i), 1); //Making enable 1
delay_FPGALoad_A();
Xil_Out32(XPAR_MYIP_AXI_LUD_WRAPPER_0_BASEADDR + 4*(20+i), 1); //Making write enable 1
delay_FPGALoad_A();
Xil_Out32(XPAR_MYIP_AXI_LUD_WRAPPER_0_BASEADDR + 4*(16+i), 0); //Making enable 0
delay_FPGALoad_A();
Xil_Out32(XPAR_MYIP_AXI_LUD_WRAPPER_0_BASEADDR + 4*(20+i), 0); //Making write enable 0
...
delay_FPGALoad_A();
val = -1;
val = Xil_In32(XPAR_MYIP_AXI_LUD_WRAPPER_0_BASEADDR + 4*(12+i)); //Reading from BRAM
delay_FPGALoad_A();
Xil_Out32(XPAR_MYIP_AXI_LUD_WRAPPER_0_BASEADDR + 4*(16+i), 0); //Making enable 0
delay_FPGALoad_A();
if(val != 0){
...
//Writing A into BRAM
for(i=0;i<A_size;i++){
Xil_Out32(XPAR_MYIP_AXI_LUD_WRAPPER_0_BASEADDR + 4*(4+A_BRAMInd[i]), A_BRAMAddr[i]); //Writing address,(4+A_BRAMInd[i]) is the offset
delay_FPGALoad_A();
val_int = float_to_int(A[i]);
Xil_Out32(XPAR_MYIP_AXI_LUD_WRAPPER_0_BASEADDR + 4*(8+A_BRAMInd[i]), val_int); //Writing data in din
delay_FPGALoad_A();
Xil_Out32(XPAR_MYIP_AXI_LUD_WRAPPER_0_BASEADDR + 4*(16+A_BRAMInd[i]), 1); //Making enable 1
delay_FPGALoad_A();
Xil_Out32(XPAR_MYIP_AXI_LUD_WRAPPER_0_BASEADDR + 4*(20+A_BRAMInd[i]), 1); //Making write enable 1
delay_FPGALoad_A();
Xil_Out32(XPAR_MYIP_AXI_LUD_WRAPPER_0_BASEADDR + 4*(16+A_BRAMInd[i]), 0); //Making enable 0
delay_FPGALoad_A();
Xil_Out32(XPAR_MYIP_AXI_LUD_WRAPPER_0_BASEADDR + 4*(20+A_BRAMInd[i]), 0); //Making write enable 0
delay_FPGALoad_A();
}
}
...
Xil_Out32(XPAR_MYIP_AXI_LUD_WRAPPER_0_BASEADDR + 4*(16+A_BRAMInd[i]), 1); //Making enable 1
delay_FPGALoad_A();
val_int = Xil_In32(XPAR_MYIP_AXI_LUD_WRAPPER_0_BASEADDR + 4*(12+A_BRAMInd[i])); //Reading from BRAM
delay_FPGALoad_A();
Xil_Out32(XPAR_MYIP_AXI_LUD_WRAPPER_0_BASEADDR + 4*(16+A_BRAMInd[i]), 0); //Making enable 0
delay_FPGALoad_A();
