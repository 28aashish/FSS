...
set_property -dict [list CONFIG.Operation_Type {{Divide}} CONFIG.Axi_Optimize_Goal {{Performance}} CONFIG.Result_Precision_Type {{Single}} CONFIG.C_Result_Exponent_Width {{8}} CONFIG.C_Result_Fraction_Width {{24}} CONFIG.C_Mult_Usage {{No_Usage}} CONFIG.Maximum_Latency {{false}} CONFIG.C_Latency {{{1}}} CONFIG.C_Rate {{1}}] [get_bd_cells design_DIV]
make_bd_pins_external  [get_bd_cells floating_point_0]
