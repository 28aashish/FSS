...
delay_FPGALoad_A();
Xil_Out32(XPAR_MYIP_AXI_LUD_WRAPPER_0_BASEADDR + 4*(6+i), 0); //Writing data in din
delay_FPGALoad_A();
Xil_Out32(XPAR_MYIP_AXI_LUD_WRAPPER_0_BASEADDR + 4*(10+i), 1); //Making enable 1
delay_FPGALoad_A();
Xil_Out32(XPAR_MYIP_AXI_LUD_WRAPPER_0_BASEADDR + 4*(12+i), 1); //Making write enable 1
delay_FPGALoad_A();
Xil_Out32(XPAR_MYIP_AXI_LUD_WRAPPER_0_BASEADDR + 4*(10+i), 0); //Making enable 0
delay_FPGALoad_A();
Xil_Out32(XPAR_MYIP_AXI_LUD_WRAPPER_0_BASEADDR + 4*(12+i), 0); //Making write enable 0
...
delay_FPGALoad_A();
val = -1;
val = Xil_In32(XPAR_MYIP_AXI_LUD_WRAPPER_0_BASEADDR + 4*(8+i)); //Reading from BRAM
delay_FPGALoad_A();
Xil_Out32(XPAR_MYIP_AXI_LUD_WRAPPER_0_BASEADDR + 4*(10+i), 0); //Making enable 0
delay_FPGALoad_A();
if(val != 0){
...
Xil_Out32(XPAR_MYIP_AXI_LUD_WRAPPER_0_BASEADDR + 4*(6+A_BRAMInd[i]), val_int); //Writing data in din
delay_FPGALoad_A();
Xil_Out32(XPAR_MYIP_AXI_LUD_WRAPPER_0_BASEADDR + 4*(10+A_BRAMInd[i]), 1); //Making enable 1
delay_FPGALoad_A();
Xil_Out32(XPAR_MYIP_AXI_LUD_WRAPPER_0_BASEADDR + 4*(12+A_BRAMInd[i]), 1); //Making write enable 1
delay_FPGALoad_A();
Xil_Out32(XPAR_MYIP_AXI_LUD_WRAPPER_0_BASEADDR + 4*(10+A_BRAMInd[i]), 0); //Making enable 0
delay_FPGALoad_A();
Xil_Out32(XPAR_MYIP_AXI_LUD_WRAPPER_0_BASEADDR + 4*(12+A_BRAMInd[i]), 0); //Making write enable 0
delay_FPGALoad_A();
}
}
...
Xil_Out32(XPAR_MYIP_AXI_LUD_WRAPPER_0_BASEADDR + 4*(10+A_BRAMInd[i]), 1); //Making enable 1
delay_FPGALoad_A();
val_int = Xil_In32(XPAR_MYIP_AXI_LUD_WRAPPER_0_BASEADDR + 4*(8+A_BRAMInd[i])); //Reading from BRAM
delay_FPGALoad_A();
Xil_Out32(XPAR_MYIP_AXI_LUD_WRAPPER_0_BASEADDR + 4*(10+A_BRAMInd[i]), 0); //Making enable 0
delay_FPGALoad_A();
