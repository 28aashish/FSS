...
EXTERN struct BRAM Xilinx_QuadPort_BRAM INITIALIZER({BRAMSize, 4, opDelay["rd"],opDelay["wr"], true});
EXTERN struct BRAM Xilinx_DualPort_BRAM INITIALIZER({BRAMSize, 2, opDelay["rd"]/2, opDelay["wr"]/2, true});
EXTERN struct BRAM Xilinx_SinglePort_BRAM INITIALIZER({BRAMSize, 1, opDelay["rd"]/2, opDelay["wr"]/2, true});
